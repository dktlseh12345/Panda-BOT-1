...
execute(message, args) {
    ...
    queue.textChannel.send(
      new MessageEmbed()
        .setColor("#F0EAD6")
        .setAuthor(`${message.author.username}#${message.author.discriminator} skipped ${args[0]} songs`, "https://cdn.discordapp.com/attachments/549903089969135627/922118403119005756/1637659979709.jpg")
    ).catch(console.error);
  }
};
